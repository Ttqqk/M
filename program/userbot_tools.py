...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        return await user.send_message(chat_id,"  انضم الحساب المساعد بنجاحّ")
        ...
        if not admin.can_manage_voice_chats:
            ...
            return await user.send_message(chat_id, "الحساب المساعد موجود بلفعل ِ")
        return await user.send_message(chat_id, "لا تلح موجود مسبقاً َ")
